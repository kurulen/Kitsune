...
o[#o + 1] = Def.Quad {
    Name = "GraphPos2",
    InitCommand = function(self)
        self:xy(-plotWidth/2, plotHeight + 5)
        self:zoomto(0,0):halign(0):draworder(1100):diffuse(color("1,1,1,1")):diffusealpha(0.1)
    end,
}

o[#o + 1] = LoadFont("Common Normal") .. {
    InitCommand = function(self)
        self:xy(-plotWidth/3, plotHeight + 5 + plotHeight/2 + 35)
        self:zoom(0.55)
        self:settext("")
...
local function makeskillsetlabeltext(i)
    return LoadFont("Common Normal") .. {
        Name = "SSLabel"..i,
        InitCommand = function(self)
            local xspace = 74   -- this is gonna look like shit on 4:3 no matter what so w.e
        ...
        UpdateAveragesMessageCommand = function(self, params)
            if song then
                ...
                local shortname = modToShortname[mod] .. (hand == 1 and " (left)" or " (right)")
...
o[#o + 1] = LoadFont("Common Normal") .. {
    InitCommand = function(self)
        self:xy(-plotWidth/2 + 12, plotHeight/2 + 12):halign(0)
...
local function ssrGraphLine(lineNum, colorToUse)
    return Def.ActorMultiVertex {
        InitCommand = function(self)
            self:y(plotHeight+5)
        end,
...
-- SSR skillset lines
for i = 1,8 do
    o[#o+1] = ssrGraphLine(i, skillsetColors[i])
end
