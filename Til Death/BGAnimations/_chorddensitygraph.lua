...
local translated_info = TranslationMatrices["ChordDensityGraph"]
...
local function updateGraphMultiVertex(parent, realgraph)
	...
	if steps then
		...
		parent:GetChild("npstext"):settext(hodth / 2 * 0.7 .. translated_info["nps"] .. ", " .. math.floor(notecount / length) .. " " .. translated_info["anps"]):y(-hidth * 0.9)
		hodth = hidth/hodth
